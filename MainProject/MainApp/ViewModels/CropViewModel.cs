...
public partial class CropViewModel : ObservableRecipient, INavigationAware
{
    ...
    public CropViewModel(INavigationService navigationService, IPuzzleSourceService puzzleSourceService)
    {
