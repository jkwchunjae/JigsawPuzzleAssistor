...
public class PuzzleTableConverterTest
{
    ...
    public void PuzzleTable_serialize_test()
    {
        var table = new PuzzleTable
        {
            Cells = new List<List<PuzzleCell>>
            {
                new List<PuzzleCell>
                {
                    new PuzzleCell { Row = 0, Column = 0, PieceName = "Piece_00000", PieceNumber = 0, TopEdgeIndex = 0 },
                    new PuzzleCell { Row = 0, Column = 1, PieceName = "Piece_00009", PieceNumber = 9, TopEdgeIndex = 1 },
                    new PuzzleCell { Row = 0, Column = 2, PieceName = "Piece_00002", PieceNumber = 2, TopEdgeIndex = 3 },
                    new PuzzleCell { Row = 0, Column = 3, PieceName = "Piece_00003", PieceNumber = 3, TopEdgeIndex = 2 },
                },
                new List<PuzzleCell>
                {
                    new PuzzleCell { Row = 1, Column = 0, PieceName = "Piece_00010", PieceNumber = 10, TopEdgeIndex = 0 },
                    new PuzzleCell { Row = 1, Column = 1, PieceName = "Piece_00019", PieceNumber = 19, TopEdgeIndex = 1 },
                    new PuzzleCell { Row = 1, Column = 2, PieceName = "Piece_00012", PieceNumber = 12, TopEdgeIndex = 3 },
                    new PuzzleCell { Row = 1, Column = 3, PieceName = "Piece_00013", PieceNumber = 13, TopEdgeIndex = 2 },
                },
            }
        };
  ...
  ""(10,0) (19,1) (12,3) (13,2)""
        ...
        Assert.Equal("Piece_00000", table.Cells[0][0].PieceName);
        ...
        Assert.Equal("Piece_00009", table.Cells[0][1].PieceName);
        ...
        Assert.Equal("Piece_00002", table.Cells[0][2].PieceName);
        ...
        Assert.Equal("Piece_00003", table.Cells[0][3].PieceName);
        ...
        Assert.Equal("Piece_00010", table.Cells[1][0].PieceName);
        ...
        Assert.Equal("Piece_00019", table.Cells[1][1].PieceName);
        ...
        Assert.Equal("Piece_00012", table.Cells[1][2].PieceName);
        ...
        Assert.Equal("Piece_00013", table.Cells[1][3].PieceName);
